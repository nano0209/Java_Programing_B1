...
public class House {
    ...
    public static void main (String [] args){
        ...
        double costOfHouse = 1000000.99;
        String address = "123Central Ave";
        int zipCode = 12345;
        boolean hasPark = true;
        double schoolRating = 4.6;


        String houseInfo = "The " + houseType + " on " + address + ", " + zipCode + " \nCosts $" + costOfHouse + "\nThe " + houseType + " has " + numberOfBedroom + " bedroom, " + numberOfBathroom + " bathrooms, " + numberOfKitchen + " kitchens" + "\nIt also includes a basement: " + isThereABasement + ", \nHas an attic: " + isThereAttic + ",\nHas a pool: " + isTherePool + ", \nIs on sale: " + isItOnSale + ", \nand has a park: " + hasPark + "\nThe schools in the area have a rating of " + schoolRating;
